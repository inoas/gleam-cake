...
- **Read Queries** (`CakeReadQuery`) are for SELECT and combined operations (UNION, INTERSECT, EXCEPT)
- **Write Queries** (`CakeWriteQuery`) are for INSERT, UPDATE, and DELETE operations
