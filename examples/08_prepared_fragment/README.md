...
This demo of Cake shows how to run a fragment with a prepared
statement.
...
See the
[src directory](https://github.com/inoas/gleam-cake/blob/v4.1.0/examples/08_prepared_fragment/src/).
